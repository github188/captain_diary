...
终于知道那个鼓泡那个家伙一口气念了那么多都是什么了，jinfo,jps,jstack,jstat,jmap,jconsole j后面的ipss mc
...
关键点：1 用setnx加锁，key要唯一，要加有效时间，且不能太长，避免死锁；
2. 释放锁，要用lua脚本，根据key取value，比较value，然后删除key即释放锁，一定要保证原子型，所以用zookeeper
